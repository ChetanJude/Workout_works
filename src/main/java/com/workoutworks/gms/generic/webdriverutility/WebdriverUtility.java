...
public class WebdriverUtility {
	...
	/*
	 * public void getScreenShot(WebDriver driver) throws IOException { String date
	 * = new Date().toString().replace(" ","_").replace(":","_"); TakesScreenshot ts
	 * = (TakesScreenshot)driver; File scr = ts.getScreenshotAs(OutputType.FILE);
