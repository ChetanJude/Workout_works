...
public class Working_with_DashboardModuleTest extends BaseClass{
	...
	public void createCategoryAndDeleteTest() throws Throwable, IOException {
		...
		UtilityClassObject.getTest().log(Status.INFO, "Confirmation msg on creation of category");
		...
		UtilityClassObject.getTest().log(Status.INFO, "Confirmation category from table");
		...
		UtilityClassObject.getTest().log(Status.INFO, "Delete the category and confirmation of deletion");
	...
	public void createPackageTypeAndDeletingWithCategoryTest() throws EncryptedDocumentException, IOException, InterruptedException {
		...
		UtilityClassObject.getTest().log(Status.INFO, "Confirmation 'Category' and 'PackageType' from table");
		...
		UtilityClassObject.getTest().log(Status.INFO, "Delete the package Type with category");
		wu.scrollToPagebottom(driver);
